import {TSearchExtended, TSearchForm, TTopList} from "./features/movieFinder/movieFinderTypes";
...
export function convertSearchFilter(form: TSearchForm): TSearchExtended {
